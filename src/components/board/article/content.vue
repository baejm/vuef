  ...
  <v-container v-else fluid :class="$vuetify.breakpoint.xs ? 'pa-0' : ''">
    <v-card outlined :tile="$vuetify.breakpoint.xs">
      <v-toolbar color="transparent" dense flat>
        ...
        >
          <v-spacer />
          <v-btn @click="articleWrite" icon color="primary"
            ><v-icon>mdi-pencil</v-icon></v-btn
          >
          <v-btn @click="remove" icon color="error"
      ...
      >
        <v-spacer />
        <v-btn @click="articleWrite" text color="primary"
          ><v-icon left>mdi-pencil</v-icon>수정</v-btn
        >
        <v-btn @click="remove" text color="error"
