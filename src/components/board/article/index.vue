  ...
  <v-container fluid v-else class="pa-0">
    <template v-for="(item, i) in items">
        ...
        >
          <v-list-item-content>
            <v-list-item-title>
              ...
              <template>
                ...
                <v-icon right v-if="item.images && item.images.length"
                  >mdi-image</v-icon
                >
              </template>
            </v-list-item-title>
          ...
          <v-list-item-action>
            <v-sheet class="d-flex justify-space-between">
              <v-icon left :color="item.readCount ? 'info' : ''"
                >mdi-eye</v-icon
              >
      ...
      <template v-else>
        <v-card
          :key="item.id"
          :class="$vuetify.breakpoint.xs ? '' : 'ma-4'"
          ...
          >
            ...
            <v-card-actions class="d-flex justify-center">
              <v-btn text color="primary"
                ><v-icon left>mdi-dots-horizontal</v-icon>더보기</v-btn
              >
            </v-card-actions>
          </v-card>
          <v-card-actions>
